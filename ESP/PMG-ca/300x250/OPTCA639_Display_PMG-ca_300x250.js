...
lib.ssMetadata = [
		{name:"OPTCA639_Display_PMG_ca_300x250_atlas_1", frames: [[591,114,578,54],[0,545,578,294],[580,545,578,225],[591,0,578,112],[591,170,188,39],[0,0,589,543]]}
];
...
// stage content:
(lib.OPTCA639_Display_PMGca_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
